...
This script builds on the 'drone-motion-controller.py' script and allows the 
drone to follow more complex flight paths.

The script connects to a local crazyflie drone and uses the 'cflib' library
to control the drone along a pre-generated set of waypoints that resembles
a figure 8 pattern. The figure 8 data points are provided by online. Note
that this script assumes that a Loco Positioning System (LPS) is integrated
with the drone microcontroller.
"""
