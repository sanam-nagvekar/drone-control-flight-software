...
'''
Logging and Connecting Test

This script tests the logging methods provided by the cflib library 
and tests the connection between the drone and local machine. This 
code was provided by the CrazyFlie setting up guide. 
'''
